...
void RayTracing::CreateBottomLevelAccelerationStructureForMesh(Mesh* mesh)
{
	...
	geometryDesc.Triangles.VertexBuffer.StartAddress = mesh->GetVertexBufferView().BufferLocation;
	...
	geometryDesc.Triangles.IndexBuffer = mesh->GetIndexBufferView().BufferLocation;
